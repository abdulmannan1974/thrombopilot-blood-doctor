    ...
    <div className="asa-guide-shell">
      ...
      <div className="asa-tab-body">
        ...
        {activeTab === "overview" && (
          <div className="asa-sections">
            ...
            <div className="asa-section-card">
              <h2 className="asa-section-title">General Principles</h2>
            ...
            <div className="asa-section-card">
              ...
              <div className="asa-ae-grid">
                ...
                <div className="asa-ae-card">
                  <span className="asa-ae-label">Present as DVT</span>
                  <span className="asa-ae-value">Two thirds</span>
                </div>
                <div className="asa-ae-card">
                  <span className="asa-ae-label">Concurrent PE</span>
                  <span className="asa-ae-value">~33%</span>
                </div>
                <div className="asa-ae-card">
                  <span className="asa-ae-label">Post-thrombotic syndrome</span>
                  <span className="asa-ae-value">Up to 50%</span>
                </div>
                <div className="asa-ae-card">
                  <span className="asa-ae-label">Recurrent DVT/PE at 10 years</span>
                  <span className="asa-ae-value">~33%</span>
                </div>
                <div className="asa-ae-card">
                  <span className="asa-ae-label">Unprovoked first-time DVT</span>
                  <span className="asa-ae-value">Up to 50%</span>
                </div>
              </div>
            </div>
            ...
            <div className="asa-section-card">
              <h2 className="asa-section-title">Anticoagulant Selection Framework</h2>
              <div className="asa-ae-grid">
                <div className="asa-ae-card">
                  <span className="asa-ae-label">Preferred first-line</span>
                  <span className="asa-ae-value">Apixaban or rivaroxaban (no lead-in, oral only)</span>
                </div>
                <div className="asa-ae-card">
                  <span className="asa-ae-label">Requires LMWH lead-in</span>
                  <span className="asa-ae-value">Dabigatran or edoxaban (5–10 day parenteral lead-in)</span>
                </div>
                <div className="asa-ae-card">
                  <span className="asa-ae-label">Severe renal impairment</span>
                  <span className="asa-ae-value">Apixaban with specialist review; UFH for CrCl &lt;15–20</span>
                </div>
                <div className="asa-ae-card">
                  <span className="asa-ae-label">Cancer-associated DVT</span>
                ...
                <div className="asa-ae-card">
                  <span className="asa-ae-label">Pregnancy</span>
                  <span className="asa-ae-value">LMWH monotherapy — DOACs contraindicated</span>
                </div>
              </div>
            </div>
          </div>
        ...
        {activeTab === "doacs" && (
          <div className="asa-sections">
            <div className="asa-section-card">
              <h2 className="asa-section-title">DOAC Dosing for DVT Treatment</h2>
              {doacRows.map((d, i) => (
        ...
        {activeTab === "lmwh" && (
          <div className="asa-sections">
            <div className="asa-section-card">
              <h2 className="asa-section-title">LMWH Dosing</h2>
              <p className="asa-section-copy">Dose based on actual body weight. Round to nearest pre-filled syringe to facilitate self-administration.</p>
            ...
            <div className="asa-section-card">
              <h2 className="asa-section-title">LMWH Advantages Over UFH</h2>
              <ul className="asa-ind-list">
        ...
        {activeTab === "warfarin" && (
          <div className="asa-sections">
            ...
            <div className="asa-section-card">
              <h2 className="asa-section-title">Unfractionated Heparin (UFH)</h2>
              <ul className="asa-ind-list">
