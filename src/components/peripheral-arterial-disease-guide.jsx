  ...
  return (
    <section className="asa-guide-shell">
      ...
      <div className="asa-tabs">
        <div className="asa-tabs-list" role="tablist" aria-label="PAD guide sections">
          {tabs.map(([id, label]) => (
            <button
              key={id}
              type="button"
        ...
        {tab === "overview" ? (
          <div className="asa-tab-panel">
            <article className="asa-section-card">
              <h3><span className="asa-dot blue" />Disease Overview</h3>
            ...
            <article className="asa-section-card">
              <h3><span className="asa-dot green" />Management Pillars</h3>
              <div className="asa-ae-grid">
                <div className="asa-ae-card default">
                  <div className="asa-ae-card-label">Antithrombotic Therapy</div>
                  <div className="asa-ae-card-text">Single antiplatelet, dual pathway (rivaroxaban 2.5 mg BID + ASA), or DAPT in selected settings</div>
                </div>
                <div className="asa-ae-card default">
                  <div className="asa-ae-card-label">Dyslipidemia</div>
                  <div className="asa-ae-card-text">High-intensity statin; target LDL reduction per guidelines</div>
                </div>
                <div className="asa-ae-card default">
                  <div className="asa-ae-card-label">Hypertension</div>
                  <div className="asa-ae-card-text">Target BP per current guidelines; ACEi/ARB preferred</div>
                </div>
                <div className="asa-ae-card default">
                  <div className="asa-ae-card-label">Diabetes</div>
                  <div className="asa-ae-card-text">Glycemic optimization; consider SGLT2i for cardiovascular benefit</div>
                </div>
                <div className="asa-ae-card default">
                  <div className="asa-ae-card-label">Smoking Cessation</div>
                  <div className="asa-ae-card-text">Most modifiable risk factor in PAD progression</div>
                </div>
                <div className="asa-ae-card default">
                  <div className="asa-ae-card-label">Exercise Therapy</div>
                  <div className="asa-ae-card-text">Supervised exercise programs improve claudication distance and quality of life</div>
                </div>
              </div>
            </article>
          </div>
        ...
        {tab === "symptomatic" ? (
          <div className="asa-tab-panel">
            <article className="asa-section-card">
              <h3><span className="asa-dot blue" />Single Antiplatelet Therapy (Standard of Care)</h3>
              <ul className="asa-ind-list">
            ...
            <article className="asa-section-card">
              <h3><span className="asa-dot cardiac" />Dual Antiplatelet Therapy (DAPT)</h3>
              <ul className="asa-ind-list">
            ...
            <article className="asa-section-card">
              <h3><span className="asa-dot danger" />Full-Dose Anticoagulation — Do NOT Add</h3>
              <ul className="asa-ind-list">
            ...
            <article className="asa-section-card">
              <h3><span className="asa-dot stroke" />Patients Already on OAC (e.g., for Atrial Fibrillation)</h3>
              <ul className="asa-ind-list">
        ...
        {tab === "revascularization" ? (
          <div className="asa-tab-panel">
            <article className="asa-section-card">
              <h3><span className="asa-dot blue" />Post-Revascularization: Preferred Regimen</h3>
              <ul className="asa-ind-list">
            ...
            <article className="asa-section-card">
              <h3><span className="asa-dot green" />VOYAGER PAD Trial</h3>
              <ul className="asa-ind-list">
            ...
            <article className="asa-section-card">
              <h3><span className="asa-dot cardiac" />If Ineligible for Rivaroxaban</h3>
              <ul className="asa-ind-list">
            ...
            <article className="asa-section-card">
              <h3><span className="asa-dot danger" />Acute Limb Ischemia</h3>
              <ul className="asa-ind-list">
        ...
        {tab === "compass" ? (
          <div className="asa-tab-panel">
            <article className="asa-section-card">
              <h3><span className="asa-dot blue" />COMPASS Trial — Chronic Stable PAD</h3>
              <ul className="asa-ind-list">
            ...
            <article className="asa-section-card">
              <h3><span className="asa-dot green" />Risk Stratification — Who Benefits Most?</h3>
            ...
            <article className="asa-section-card">
              <h3><span className="asa-dot cardiac" />Clinical Takeaway</h3>
              <ul className="asa-ind-list">
        ...
        {tab === "periprocedural" ? (
          <div className="asa-tab-panel">
            <article className="asa-section-card">
              <h3><span className="asa-dot blue" />ASA Periprocedural Management</h3>
              <ul className="asa-ind-list">
            ...
            <article className="asa-section-card">
              <h3><span className="asa-dot cardiac" />Low-Dose Rivaroxaban Periprocedural Management</h3>
              <ul className="asa-ind-list">
        ...
        {tab === "references" ? (
          <div className="asa-tab-panel">
            <article className="asa-section-card">
              <h3><span className="asa-dot blue" />Key References</h3>
              <ol className="asa-ind-list">
                {references.map((ref) => (
                  <li key={ref}>{ref}</li>
                ))}
              </ol>
